    ...
    <div class="main">
        ...
        <section>
            ...
            <div class="breadcrumb">
                <a href="<?=BASE_URL?>/">Home</a>&nbsp;&nbsp;<i class="fa fa-caret-right" style="color:#ABABAB" aria-hidden="true"></i>&nbsp;&nbsp;<a href="<?=BASE_URL?>/admin/">Administration</a><?=SPACER?><a href="<?=BASE_URL?>/admin/system-log/index.php">System Log</a><?=SPACER?><?=date("F j, Y", strtotime($xDate . " 00:00:00"))?>
            </div>
            <form action="<?=BASE_URL?>/admin/system-log/date_logs.php" method="post" name="CreateReport">
                    ...
                    if (isset($xDate)) {
                        ...
                        if ($row_cnt === 0) {
                            ...
                            while($logRS = mysqli_fetch_assoc($response)) {
                                ...
                                ?>
                                <tr>
                                    <td class="tac"><?=$logType?></td>
                                    <td><?=date("F j, Y", strtotime($logRS["LogDate"]))?></td>
