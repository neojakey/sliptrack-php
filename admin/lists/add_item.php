...
<body>
    <div id="page-wrapper">
        ...
        <div class="main">
            ...
            <section>
                <h1 class="page-title">Add New List Item</h1>
                ...
                <form action="<?=BASE_URL?>/admin/lists/save_item.php" id="item-form" method="post">
                    ...
                    <input type="hidden" name="hidListItemId" value=""/>
                    <table class="form-table">
                        <tr>
                            <td style="width:200px">Item Name <?=REQUIRED?>:</td>
                            <td><input type="text" class="k-textbox" id="item-name" name="tbItemName" style="width:500px" maxlength="200"/></td>
                        </tr>
                        <tr>
                            <td>Item Code <?=REQUIRED?>:</td>
                            <td><input type="text" class="k-textbox" id="item-code" style="width:120px" name="tbItemCode" maxlength="10"/></td>
                        </tr>
                        <tr>
                            <td>Item Description:</td>
                            <td><textarea class="k-textbox" id="item-description" maxlength="255" style="width:450px; height:100px; border: 1px #CCC solid" name="tbItemDescription"></textarea></td>
                        </tr>
                    </table>
